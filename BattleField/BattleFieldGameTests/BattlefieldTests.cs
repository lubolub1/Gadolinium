...
namespace BattleFieldGameTests
{
    ...
    public class BattlefieldTests
    {
        ...
        public void ExtractMineFromStringCorrectInputTest()
        {
            ...
            Mine testedMine = Battlefield.ExtractMineFromString(test);
        ...
        public void ExtractMineFromStringIncorrectInputTest1()
        {
            ...
            Assert.IsNull(Battlefield.ExtractMineFromString(test));
        }
        ...
        public void StringifyFieldTest()
        {
            ...
            Assert.AreEqual(expectedResult, Battlefield.StringifyField(testedField));
        }
    }
}
